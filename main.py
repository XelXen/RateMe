...
root = backend.get_root(config.DATABASE_FILE)
...
async def start_message(client: Client, message: Message):
    await message.reply_text(
        text="Hi there! I am RateMe Bot. I can help you rate and review users, channels and communities. You can also use me to moderate your community by restricting low-rated users.",
